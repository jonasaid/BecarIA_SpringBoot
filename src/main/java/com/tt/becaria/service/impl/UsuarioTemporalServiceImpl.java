...
import com.tt.becaria.controller.impl.UsuarioTemporalControllerImp;
...
public class UsuarioTemporalServiceImpl implements UsuarioTemporalService {
    private final UsuarioTemporalControllerImp controller;

    /**
     * Constructor de la clase UsuarioTemporalServiceImpl.
     *
     * @param controller El controlador UsuarioTemporalControllerImp utilizado para realizar
     *                   las operaciones de gestión de registros UsuarioTemporal.
     */
    public UsuarioTemporalServiceImpl(UsuarioTemporalControllerImp controller) {
